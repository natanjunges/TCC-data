(define (domain pfl)
(:requirements :strips)
(:types object object - object message - object i - message s - message b - message iq - message sq - message variable - object oi1 - variable oi2 - variable oi - variable w1 - variable w2 - variable)
(:predicates
...
(:action goto-rrc1
	...
	:precondition (and (sent-to-human ?i) (not (sent-to-human ?iq)) (not (sent-to-robot ?i)) (not (set ?oi)) (not (set ?w1)) (not (set ?w2)))
	:effect (and 
		(sent-to-robot ?iq)
		(not (sent-to-human ?i))
	)
...
(:action goto-rrc2
	...
	:precondition (and (sent-to-human ?iq))
	:effect (and 
		(set ?oi1)
...
(:action goto-tw
	...
	:precondition (and (sent-to-human ?s) (set ?w1) (set ?w2))
	:effect (and 
		(sent-to-robot ?s)
		(not (set ?w2))
	)
...
(:action goto-rwc2
	...
	:precondition (and (sent-to-human ?sq) (set ?w1) (sent-to-robot ?sq) (set ?w2))
	:effect (and 
		(not (set ?w1))
		(not (set ?w2))
	)
...
(:action goto-tir
	:parameters (?oi1 - oi1 ?oi2 - oi2 ?w - w ?i - i)
	:precondition (and (not (sent-to-robot ?i)) (set ?oi1) (not (set ?oi2)) (not (set ?w)))
	:effect (and 
		(sent-to-human ?i)
	)
)
...
(:action goto-rirc1
	:parameters (?oi - oi ?w1 - w1 ?w2 - w2 ?i - i ?iq - iq)
	:precondition (and (sent-to-robot ?iq) (sent-to-human ?i) (not (sent-to-human ?iq)) (not (sent-to-robot ?i)) (not (set ?oi)) (not (set ?w1)) (not (set ?w2)))
	:effect (and 
		(not (sent-to-human ?i))
	)
)
...
(:action goto-rirc2
	:parameters (?oi1 - oi1 ?oi2 - oi2 ?w - w ?iq - iq)
	:precondition (and (set ?oi1) (sent-to-human ?iq))
	:effect (and 
		(sent-to-robot ?iq)
		(not (set ?oi1))
	)
...
(:action goto-ric1
	:parameters (?w - w ?s - s ?sq - sq)
	:precondition (and (sent-to-human ?sq) (sent-to-robot ?sq) (sent-to-human ?s))
	:effect (and 
		(sent-to-robot ?s)
...
(:action goto-ric2
	...
	:precondition (and (set ?w2) (sent-to-human ?sq) (set ?w1))
	:effect (and 
		(not (set ?w1))
	)
)
