...
(:action goto-rrc1
	...
	:precondition (and (sent-to-human ?i) (set ?w1) (set ?w2) (set ?oi) (not (sent-to-human ?iq)) (not (sent-to-robot ?i)))
	:effect (and 
		(sent-to-robot ?iq)
		(not (sent-to-human ?i))
	)
...
(:action goto-cr
	...
	:precondition (and (sent-to-robot ?b) (sent-to-human ?b) (set ?oi1) (set ?oi2))
	:effect (and 
		(not (set ?oi1))
	)
)
...
(:action goto-tw
	...
	:precondition (and (sent-to-robot ?s) (sent-to-human ?s) (set ?w1))
	:effect (and 
		(not (set ?w1))
	)
)
...
(:action goto-rwc1
	...
	:precondition (and (sent-to-robot ?s) (sent-to-human ?sq))
	:effect (and 
		(not (sent-to-robot ?s))
		(sent-to-robot ?sq)
		(sent-to-human ?s)
...
(:action goto-rirc1
	:parameters (?oi - oi ?w1 - w1 ?w2 - w2 ?i - i ?iq - iq)
	:precondition (and (sent-to-human ?i) (not (sent-to-human ?iq)) (not (sent-to-robot ?i)) (not (set ?w1)) (not (set ?w2)))
	:effect (and 
		(sent-to-robot ?iq)
		(set ?oi)
		(not (sent-to-human ?i))
...
(:action goto-rirc2
	:parameters (?oi1 - oi1 ?oi2 - oi2 ?w - w ?iq - iq)
	:precondition (and (sent-to-robot ?iq) (set ?oi1) (sent-to-human ?iq) (set ?oi2))
	:effect (and 
...
(:action goto-ric1
	:parameters (?w - w ?s - s ?sq - sq)
	:precondition (and (sent-to-human ?sq) (sent-to-human ?s))
	:effect (and 
		(sent-to-robot ?s)
		(sent-to-robot ?sq)
	)
