...
(:action goto-rrc1
	...
	:precondition (and (sent-to-human ?i) (set ?w2) (not (sent-to-human ?iq)) (not (sent-to-robot ?i)) (sent-to-robot ?iq) (not (set ?oi)) (not (set ?w1)))
	:effect (and 
		(not (sent-to-human ?i))
	)
)
...
(:action goto-cr
	...
	:precondition (and (set ?oi2) (sent-to-robot ?b) (sent-to-human ?b) (set ?oi1))
	:effect (and 
		(not (set ?oi2))
		(not (sent-to-robot ?b))
		(not (set ?oi1))
...
(:action goto-tw
	...
	:precondition (and (set ?w2) (sent-to-human ?s))
	:effect (and 
		(not (set ?w2))
		(not (sent-to-human ?s))
	)
...
(:action goto-cw1
	...
	:precondition (and (set ?w1) (sent-to-human ?b) (sent-to-robot ?b))
	:effect (and 
	)
)
...
(:action goto-ric2
	...
	:precondition (and (set ?w1) (sent-to-human ?sq))
	:effect (and 
		(sent-to-robot ?sq)
	)
)
...
(:action goto-ci1
	...
	:precondition (and (set ?w2) (set ?oi) (sent-to-robot ?b))
	:effect (and 
		(not (set ?w2))
		(not (sent-to-robot ?b))
		(sent-to-human ?b)
