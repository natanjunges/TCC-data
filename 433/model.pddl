...
(:action goto-cr
	...
	:precondition (and (sent-to-human ?b) (set ?oi2) (sent-to-robot ?b) (set ?oi1))
	:effect (and 
		(not (sent-to-human ?b))
		(not (sent-to-robot ?b))
	)
...
(:action goto-rwc2
	...
	:precondition (and (sent-to-human ?sq) (set ?w2) (set ?w1))
	:effect (and 
		(sent-to-robot ?sq)
	)
)
...
(:action goto-rirc1
	:parameters (?oi - oi ?w1 - w1 ?w2 - w2 ?i - i ?iq - iq)
	:precondition (and (sent-to-robot ?i) (sent-to-human ?i))
	:effect (and 
		(sent-to-robot ?iq)
		(not (sent-to-human ?i))
	)
...
(:action goto-rirc2
	:parameters (?oi1 - oi1 ?oi2 - oi2 ?w - w ?iq - iq)
	:precondition (and (sent-to-robot ?iq) (sent-to-human ?iq) (set ?oi1))
	:effect (and 
