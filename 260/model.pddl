...
(:action goto-tr
	...
	:precondition (and (sent-to-human ?i) (set ?oi2) (sent-to-robot ?i) (set ?w))
	:effect (and 
		(set ?oi1)
		(not (sent-to-robot ?i))
	)
...
(:action goto-cr
	...
	:precondition (and (set ?oi1) (sent-to-human ?b) (set ?oi2))
	:effect (and 
	)
)
...
(:action goto-tw
	...
	:precondition (and (set ?w1) (sent-to-human ?s) (set ?w2) (sent-to-robot ?s))
	:effect (and 
		(not (sent-to-human ?s))
		(not (sent-to-robot ?s))
	)
...
(:action goto-rwc2
	...
	:precondition (and (set ?w1) (sent-to-human ?sq) (set ?w2))
	:effect (and 
