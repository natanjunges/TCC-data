...
(:action goto-rrc1
	...
	:precondition (and (sent-to-human ?i) (set ?w2) (set ?oi) (set ?w1) (not (sent-to-human ?iq)) (not (sent-to-robot ?i)) (sent-to-robot ?iq))
	:effect (and 
		(not (sent-to-human ?i))
	)
)
...
(:action goto-rrc2
	...
	:precondition (and (sent-to-robot ?iq) (not (sent-to-human ?iq)) (not (set ?w)))
	:effect (and 
...
(:action goto-rwc1
	...
	:precondition (and (sent-to-human ?sq) (sent-to-robot ?s) (sent-to-human ?s))
	:effect (and 
		(not (sent-to-human ?s))
	)
)
...
(:action goto-cir
	:parameters (?oi1 - oi1 ?oi2 - oi2 ?b - b)
	:precondition (and (sent-to-robot ?b) (set ?oi1))
	:effect (and 
		(sent-to-human ?b)
		(set ?oi2)
		(not (sent-to-robot ?b))
