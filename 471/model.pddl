...
(:action goto-rrc1
	...
	:precondition (and (set ?oi) (sent-to-human ?i) (set ?w1) (set ?w2) (not (sent-to-human ?iq)) (not (sent-to-robot ?i)))
	:effect (and 
		(sent-to-robot ?iq)
		(not (sent-to-human ?i))
	)
...
(:action goto-cr
	...
	:precondition (and (set ?oi2) (not (sent-to-robot ?b)) (set ?oi1))
	:effect (and 
		(sent-to-human ?b)
	)
)
...
(:action goto-tw
	...
	:precondition (and (set ?w2) (set ?w1) (not (sent-to-human ?s)))
	:effect (and 
		(sent-to-robot ?s)
	)
)
...
(:action goto-rwc1
	...
	:precondition (and (sent-to-human ?s) (sent-to-robot ?sq) (sent-to-robot ?s))
	:effect (and 
		(not (sent-to-robot ?s))
		(sent-to-human ?sq)
	)
...
(:action goto-rwc2
	...
	:precondition (and (sent-to-robot ?sq) (sent-to-human ?sq) (set ?w2))
	:effect (and 
		(set ?w1)
...
(:action goto-cw1
	...
	:precondition (and (sent-to-robot ?b) (sent-to-human ?b) (set ?w2))
	:effect (and 
		(not (sent-to-robot ?b))
		(set ?w1)
		(not (sent-to-human ?b))
...
(:action goto-rirc1-pre
	:parameters (?w1 - w1 ?w2 - w2)
	:precondition (and (not (set ?w1)) (not (set ?w2)))
	:effect (and 
	)
)
...
(:action goto-rirc2
	:parameters (?oi1 - oi1 ?oi2 - oi2 ?w - w ?iq - iq)
	:precondition (and (sent-to-robot ?iq) (set ?oi1))
	:effect (and 
		(not (sent-to-robot ?iq))
		(not (set ?oi1))
	)
