...
(:action goto-tr
	...
	:precondition (and (set ?w) (set ?oi1) (sent-to-robot ?i) (sent-to-human ?i) (set ?oi2))
	:effect (and 
	)
)
...
(:action goto-rrc1
	...
	:precondition (and (set ?w2) (set ?oi) (sent-to-robot ?i) (sent-to-robot ?iq) (set ?w1))
	:effect (and 
		(not (sent-to-robot ?i))
		(sent-to-human ?i)
	)
...
(:action goto-rwc1
	...
	:precondition (and (sent-to-robot ?s) (sent-to-human ?s) (sent-to-robot ?sq) (sent-to-human ?sq))
	:effect (and 
		(not (sent-to-robot ?s))
		(not (sent-to-human ?s))
	)
...
(:action goto-rwc2
	...
	:precondition (and (set ?w2) (sent-to-robot ?sq) (sent-to-human ?sq))
	:effect (and 
		(set ?w1)
...
(:action goto-cw1
	...
	:precondition (and (set ?w1) (sent-to-human ?b))
	:effect (and 
		(set ?w2)
		(sent-to-robot ?b)
		(not (sent-to-human ?b))
