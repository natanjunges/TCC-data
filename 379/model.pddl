...
(:action goto-rrc1
	...
	:precondition (and (sent-to-human ?i) (set ?w2) (not (sent-to-human ?iq)) (not (sent-to-robot ?i)))
	:effect (and 
		(sent-to-robot ?iq)
		(set ?w1)
		(not (sent-to-human ?i))
...
(:action goto-rwc2
	...
	:precondition (and (sent-to-human ?sq) (set ?w2) (sent-to-robot ?sq) (set ?w1))
	:effect (and 
...
(:action goto-cw1
	...
	:precondition (and (sent-to-human ?b) (set ?w2) (sent-to-robot ?b) (set ?w1))
	:effect (and 
		(not (sent-to-human ?b))
	)
)
