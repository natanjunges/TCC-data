...
(:action goto-rrc2
	...
	:precondition (and (set ?w) (sent-to-human ?iq) (sent-to-robot ?iq))
	:effect (and 
		(set ?oi1)
		(set ?oi2)
	)
...
(:action goto-cr
	...
	:precondition (and (set ?oi1) (set ?oi2) (sent-to-human ?b) (sent-to-robot ?b))
	:effect (and 
		(not (set ?oi1))
		(not (sent-to-human ?b))
		(not (set ?oi2))
...
(:action goto-tw
	...
	:precondition (and (set ?w1) (sent-to-robot ?s) (set ?w2))
	:effect (and 
		(sent-to-human ?s)
		(not (sent-to-robot ?s))
	)
...
(:action goto-rirc2
	:parameters (?oi1 - oi1 ?oi2 - oi2 ?w - w ?iq - iq)
	:precondition (and (set ?oi1) (sent-to-robot ?iq) (set ?oi2))
	:effect (and 
		(not (set ?oi1))
		(not (set ?oi2))
	)
