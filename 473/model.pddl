...
(:action goto-tr
	...
	:precondition (and (set ?oi1) (sent-to-human ?i) (sent-to-robot ?i) (set ?w))
	:effect (and 
		(not (set ?oi1))
		(set ?oi2)
	)
...
(:action goto-rrc1-pre
	...
	:precondition (and (set ?w2) (not (set ?w1)))
	:effect (and 
	)
)
...
(:action goto-cw1
	...
	:precondition (and (set ?w2) (sent-to-robot ?b))
	:effect (and 
		(not (sent-to-robot ?b))
		(sent-to-human ?b)
	)
...
(:action goto-rirc1
	:parameters (?oi - oi ?w1 - w1 ?w2 - w2 ?i - i ?iq - iq)
	:precondition (and (sent-to-robot ?i) (sent-to-robot ?iq) (sent-to-human ?i))
	:effect (and 
		(not (sent-to-robot ?i))
		(set ?oi)
	)
...
(:action goto-rirc2
	:parameters (?oi1 - oi1 ?oi2 - oi2 ?w - w ?iq - iq)
	:precondition (and (sent-to-human ?iq) (set ?oi1))
	:effect (and 
		(sent-to-robot ?iq)
...
(:action goto-cir
	:parameters (?oi1 - oi1 ?oi2 - oi2 ?b - b)
	:precondition (and (sent-to-robot ?b) (set ?oi1) (sent-to-human ?b))
	:effect (and 
		(not (set ?oi1))
	)
)
