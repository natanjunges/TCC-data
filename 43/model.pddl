...
(:action goto-rrc1
	...
	:precondition (and (set ?w2) (set ?w1) (sent-to-human ?i) (not (sent-to-human ?iq)) (not (sent-to-robot ?i)) (not (set ?oi)))
	:effect (and 
		(not (sent-to-human ?i))
		(sent-to-robot ?iq)
	)
...
(:action goto-rrc2
	...
	:precondition (and (sent-to-robot ?iq) (set ?oi1) (sent-to-human ?iq))
	:effect (and 
...
(:action goto-cr
	...
	:precondition (and (sent-to-robot ?b) (set ?oi1) (set ?oi2))
	:effect (and 
		(not (sent-to-robot ?b))
		(sent-to-human ?b)
		(not (set ?oi1))
