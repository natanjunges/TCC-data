...
(:action goto-rrc1
	...
	:precondition (and (set ?w1) (sent-to-human ?i) (set ?oi) (set ?w2) (not (sent-to-human ?iq)) (not (sent-to-robot ?i)))
	:effect (and 
		(sent-to-robot ?iq)
		(not (sent-to-human ?i))
	)
...
(:action goto-rrc2
	...
	:precondition (and (sent-to-robot ?iq))
	:effect (and 
		(sent-to-human ?iq)
	)
)
...
(:action goto-cr
	...
	:precondition (and (set ?oi2) (sent-to-human ?b) (set ?oi1))
	:effect (and 
		(not (set ?oi2))
		(not (sent-to-human ?b))
	)
...
(:action goto-rwc1
	...
	:precondition (and (sent-to-robot ?s) (sent-to-robot ?sq) (sent-to-human ?sq))
	:effect (and 
		(not (sent-to-robot ?s))
...
(:action goto-rwc2
	...
	:precondition (and (set ?w2) (sent-to-robot ?sq) (set ?w1))
	:effect (and 
		(sent-to-human ?sq)
	)
)
...
(:action goto-rirc1
	:parameters (?oi - oi ?w1 - w1 ?w2 - w2 ?i - i ?iq - iq)
	:precondition (and (sent-to-robot ?i))
	:effect (and 
		(sent-to-human ?i)
	)
)
...
(:action goto-ric1
	:parameters (?w - w ?s - s ?sq - sq)
	:precondition (and (sent-to-human ?s) (sent-to-robot ?sq) (sent-to-human ?sq))
	:effect (and 
		(sent-to-robot ?s)
		(not (sent-to-human ?s))
		(not (sent-to-robot ?sq))
