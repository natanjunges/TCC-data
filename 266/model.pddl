...
(:action goto-rrc2
	...
	:precondition (and (set ?oi1) (sent-to-robot ?iq) (set ?w))
	:effect (and 
		(sent-to-human ?iq)
		(set ?oi2)
	)
...
(:action goto-rirc1
	:parameters (?oi - oi ?w1 - w1 ?w2 - w2 ?i - i ?iq - iq)
	:precondition (and (sent-to-human ?i) (sent-to-robot ?iq) (not (sent-to-human ?iq)) (not (sent-to-robot ?i)) (not (set ?oi)) (set ?w1) (not (set ?w2)))
	:effect (and 
		(not (sent-to-human ?i))
	)
)
