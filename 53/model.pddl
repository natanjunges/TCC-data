...
(:action goto-rrc1
	...
	:precondition (and (sent-to-human ?iq) (set ?w1) (sent-to-human ?i) (set ?w2))
	:effect (and 
		(sent-to-robot ?iq)
		(set ?oi)
	)
...
(:action goto-rrc2
	...
	:precondition (and (sent-to-human ?iq) (set ?w) (set ?oi1))
	:effect (and 
...
(:action goto-tw
	...
	:precondition (and (set ?w2) (set ?w1) (sent-to-human ?s))
	:effect (and 
	)
)
