...
(:action goto-rrc1
	...
	:precondition (and (set ?w2) (set ?oi) (sent-to-human ?iq) (sent-to-robot ?iq) (set ?w1))
	:effect (and 
		(sent-to-human ?i)
	)
)
...
(:action goto-rrc2
	...
	:precondition (and (set ?oi2) (set ?oi1) (sent-to-robot ?iq))
	:effect (and 
		(sent-to-human ?iq)
		(not (set ?oi2))
...
(:action goto-tir
	:parameters (?oi1 - oi1 ?oi2 - oi2 ?w - w ?i - i)
	:precondition (and (sent-to-human ?i) (set ?oi1) (sent-to-robot ?i))
	:effect (and 
	)
)
