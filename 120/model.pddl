...
(:action goto-rrc1
	...
	:precondition (and (set ?w2) (set ?oi) (sent-to-human ?i) (set ?w1) (not (sent-to-human ?iq)) (not (sent-to-robot ?i)))
	:effect (and 
		(sent-to-robot ?iq)
		(not (sent-to-human ?i))
	)
...
(:action goto-rrc2
	...
	:precondition (and (set ?oi1) (sent-to-robot ?iq))
	:effect (and 
		(set ?oi2)
...
(:action goto-cr
	...
	:precondition (and (sent-to-human ?b) (set ?oi2) (set ?oi1) (sent-to-robot ?b))
	:effect (and 
		(not (sent-to-human ?b))
		(not (sent-to-robot ?b))
	)
...
(:action goto-rwc1
	...
	:precondition (and (sent-to-human ?s) (sent-to-human ?sq))
	:effect (and 
		(sent-to-robot ?s)
...
(:action goto-rirc1
	:parameters (?oi - oi ?w1 - w1 ?w2 - w2 ?i - i ?iq - iq)
	:precondition (and (sent-to-human ?i) (set ?oi) (not (sent-to-human ?iq)) (not (sent-to-robot ?i)) (not (set ?w1)) (not (set ?w2)))
	:effect (and 
		(sent-to-robot ?iq)
		(not (sent-to-human ?i))
		(not (set ?oi))
