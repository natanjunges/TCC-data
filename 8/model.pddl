...
(:action goto-rrc1
	...
	:precondition (and (set ?w2) (set ?oi) (set ?w1))
	:effect (and 
		(sent-to-human ?iq)
		(sent-to-robot ?i)
		(sent-to-human ?i)
...
(:action goto-rrc2
	...
	:precondition (and (set ?oi2) (set ?oi1) (sent-to-robot ?iq) (sent-to-human ?iq))
	:effect (and 
		(not (set ?oi1))
	)
)
...
(:action goto-tw
	...
	:precondition (and (set ?w2) (sent-to-robot ?s) (sent-to-human ?s))
	:effect (and 
		(not (set ?w2))
		(not (sent-to-robot ?s))
		(not (sent-to-human ?s))
...
(:action goto-tir
	:parameters (?oi1 - oi1 ?oi2 - oi2 ?w - w ?i - i)
	:precondition (and (sent-to-human ?i))
	:effect (and 
		(set ?oi2)
		(not (sent-to-human ?i))
	)
...
(:action goto-rirc2
	:parameters (?oi1 - oi1 ?oi2 - oi2 ?w - w ?iq - iq)
	:precondition (and (set ?oi2) (sent-to-robot ?iq) (set ?oi1))
	:effect (and 
	)
)
