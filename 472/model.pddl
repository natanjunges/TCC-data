...
(:action goto-tr
	...
	:precondition (and (set ?oi1) (set ?w))
	:effect (and 
		(sent-to-robot ?i)
		(sent-to-human ?i)
		(set ?oi2)
...
(:action goto-tw
	...
	:precondition (and (set ?w1) (not (sent-to-human ?s)) (not (set ?w2)))
	:effect (and 
		(sent-to-robot ?s)
		(not (set ?w1))
	)
...
(:action goto-cw1
	...
	:precondition (and (set ?w2) (sent-to-robot ?b) (set ?w1))
	:effect (and 
		(not (set ?w1))
	)
)
...
(:action goto-rirc1
	:parameters (?oi - oi ?w1 - w1 ?w2 - w2 ?i - i ?iq - iq)
	:precondition (and (sent-to-robot ?i) (sent-to-robot ?iq) (sent-to-human ?i) (sent-to-human ?iq))
	:effect (and 
		(not (sent-to-human ?i))
...
(:action goto-ric1
	:parameters (?w - w ?s - s ?sq - sq)
	:precondition (and (sent-to-robot ?sq) (sent-to-robot ?s) (sent-to-human ?sq))
	:effect (and 
		(sent-to-human ?s)
