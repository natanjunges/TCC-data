...
(:action goto-cr
	...
	:precondition (and (sent-to-human ?b) (set ?oi2) (set ?oi1))
	:effect (and 
	)
)
...
(:action goto-tw
	...
	:precondition (and (sent-to-human ?s) (set ?w2) (set ?w1) (sent-to-robot ?s))
	:effect (and 
		(not (sent-to-human ?s))
		(not (sent-to-robot ?s))
	)
...
(:action goto-rwc1
	...
	:precondition (and (sent-to-human ?sq) (sent-to-robot ?s))
	:effect (and 
	)
)
