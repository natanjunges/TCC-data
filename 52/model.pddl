...
(:action goto-rrc2
	...
	:precondition (and (sent-to-robot ?iq) (set ?w) (set ?oi1) (not (sent-to-human ?iq)))
	:effect (and 
		(set ?oi2)
...
(:action goto-cr
	...
	:precondition (and (set ?oi2) (set ?oi1) (not (sent-to-robot ?b)))
	:effect (and 
		(sent-to-human ?b)
	)
)
...
(:action goto-rwc1
	...
	:precondition (and (sent-to-human ?s) (sent-to-robot ?s) (sent-to-human ?sq))
	:effect (and 
		(sent-to-robot ?sq)
		(not (sent-to-human ?s))
		(not (sent-to-robot ?s))
...
(:action goto-rwc2
	...
	:precondition (and (sent-to-robot ?sq) (set ?w2) (set ?w1))
	:effect (and 
		(not (set ?w1))
		(sent-to-human ?sq)
	)
...
(:action goto-rirc2
	:parameters (?oi1 - oi1 ?oi2 - oi2 ?w - w ?iq - iq)
	:precondition (and (sent-to-robot ?iq) (set ?w) (not (sent-to-human ?iq)) (set ?oi1))
	:effect (and 
		(set ?oi2)
		(not (sent-to-robot ?iq))
	)
...
(:action goto-ric2
	...
	:precondition (and (sent-to-human ?sq) (set ?oi))
	:effect (and 
		(set ?w1)
		(sent-to-robot ?sq)
		(not (set ?oi))
