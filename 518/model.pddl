...
(:action goto-rrc1
	...
	:precondition (and (set ?w2) (sent-to-human ?i) (not (sent-to-human ?iq)) (not (sent-to-robot ?i)))
	:effect (and 
		(sent-to-robot ?iq)
		(set ?oi)
		(not (sent-to-human ?i))
...
(:action goto-rwc2
	...
	:precondition (and (sent-to-robot ?sq) (sent-to-human ?sq) (set ?w1))
	:effect (and 
...
(:action goto-cw1
	...
	:precondition (and (sent-to-human ?b) (set ?w1))
	:effect (and 
		(not (set ?w1))
	)
)
...
(:action goto-rirc1
	:parameters (?oi - oi ?w1 - w1 ?w2 - w2 ?i - i ?iq - iq)
	:precondition (and (set ?oi) (sent-to-human ?i) (not (sent-to-human ?iq)) (not (sent-to-robot ?i)))
	:effect (and 
		(sent-to-robot ?iq)
		(set ?w2)
		(not (sent-to-human ?i))
...
(:action goto-ric1
	:parameters (?w - w ?s - s ?sq - sq)
	:precondition (and (sent-to-robot ?s) (sent-to-robot ?sq) (sent-to-human ?s))
	:effect (and 
		(sent-to-human ?sq)
		(not (sent-to-human ?s))
	)
...
(:action goto-ric2
	...
	:precondition (and (set ?w1) (set ?w2) (sent-to-robot ?sq) (set ?oi))
	:effect (and 
		(not (set ?w2))
		(sent-to-human ?sq)
		(not (set ?w1))
...
(:action goto-ci1
	...
	:precondition (and (sent-to-human ?b) (set ?oi) (set ?w2))
	:effect (and 
		(not (set ?oi))
		(not (set ?w2))
	)
