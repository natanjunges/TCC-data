...
(:action goto-rrc1
	...
	:precondition (and (sent-to-human ?i) (set ?w2) (not (sent-to-human ?iq)) (not (sent-to-robot ?i)) (not (set ?oi)) (set ?w1))
	:effect (and 
		(not (sent-to-human ?i))
		(sent-to-robot ?iq)
	)
...
(:action goto-rrc2
	...
	:precondition (and (sent-to-human ?iq) (sent-to-robot ?iq))
	:effect (and 
...
(:action goto-cw1
	...
	:precondition (and (set ?w1) (sent-to-robot ?b) (set ?w2))
	:effect (and 
		(not (set ?w1))
		(sent-to-human ?b)
	)
...
(:action goto-rirc2
	:parameters (?oi1 - oi1 ?oi2 - oi2 ?w - w ?iq - iq)
	:precondition (and (set ?w) (set ?oi1) (sent-to-robot ?iq) (not (sent-to-human ?iq)))
	:effect (and 
		(set ?oi2)
		(not (sent-to-robot ?iq))
	)
...
(:action goto-cir
	:parameters (?oi1 - oi1 ?oi2 - oi2 ?b - b)
	:precondition (and (set ?oi2) (not (sent-to-robot ?b)))
	:effect (and 
		(set ?oi1)
		(sent-to-human ?b)
	)
...
(:action goto-ric1
	:parameters (?w - w ?s - s ?sq - sq)
	:precondition (and (sent-to-robot ?s) (sent-to-human ?sq) (sent-to-human ?s))
	:effect (and 
		(not (sent-to-human ?s))
	)
)
...
(:action goto-ric2
	...
	:precondition (and (set ?oi) (sent-to-robot ?sq))
	:effect (and 
		(sent-to-human ?sq)
...
(:action goto-ci1
	...
	:precondition (and (set ?oi) (sent-to-human ?b) (sent-to-robot ?b))
	:effect (and 
		(not (sent-to-robot ?b))
	)
)
