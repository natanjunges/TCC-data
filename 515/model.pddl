...
(:action goto-rrc2
	...
	:precondition (and (set ?oi2) (set ?w) (set ?oi1))
	:effect (and 
		(not (set ?oi1))
		(sent-to-human ?iq)
	)
...
(:action goto-tw
	...
	:precondition (and (sent-to-robot ?s) (set ?w1) (set ?w2))
	:effect (and 
		(not (sent-to-robot ?s))
		(not (set ?w1))
	)
...
(:action goto-rirc1
	:parameters (?oi - oi ?w1 - w1 ?w2 - w2 ?i - i ?iq - iq)
	:precondition (and (sent-to-human ?i) (set ?w2) (set ?oi) (not (sent-to-human ?iq)) (not (sent-to-robot ?i)))
	:effect (and 
		(sent-to-robot ?iq)
		(not (sent-to-human ?i))
		(set ?w1)
...
(:action goto-ric2
	...
	:precondition (and (set ?oi) (sent-to-human ?sq))
	:effect (and 
	)
)
