...
(:action goto-tr
	...
	:precondition (and (sent-to-robot ?i) (set ?oi2) (set ?w) (set ?oi1) (sent-to-human ?i))
	:effect (and 
	)
)
...
(:action goto-rrc1
	...
	:precondition (and (sent-to-robot ?i) (sent-to-robot ?iq) (set ?w1) (set ?w2) (set ?oi))
	:effect (and 
		(sent-to-human ?iq)
	)
)
...
(:action goto-rrc2
	...
	:precondition (and (set ?oi1) (sent-to-human ?iq) (set ?w))
	:effect (and 
		(set ?oi2)
		(sent-to-robot ?iq)
		(not (set ?oi1))
...
(:action goto-cw1
	...
	:precondition (and (set ?w2) (sent-to-robot ?b) (sent-to-human ?b))
	:effect (and 
		(not (sent-to-human ?b))
		(set ?w1)
	)
