...
(:action goto-rrc1
	...
	:precondition (and (sent-to-human ?i) (set ?w1) (set ?w2) (not (sent-to-human ?iq)) (not (sent-to-robot ?i)) (not (set ?oi)))
	:effect (and 
		(sent-to-robot ?iq)
		(not (sent-to-human ?i))
	)
...
(:action goto-cr
	...
	:precondition (and (set ?oi1) (sent-to-human ?b))
	:effect (and 
		(set ?oi2)
	)
)
...
(:action goto-rirc2
	:parameters (?oi1 - oi1 ?oi2 - oi2 ?w - w ?iq - iq)
	:precondition (and (sent-to-robot ?iq) (sent-to-human ?iq) (set ?oi1) (set ?oi2))
	:effect (and 
	)
)
