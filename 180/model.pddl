...
(:action goto-tr
	...
	:precondition (and (set ?oi2) (set ?w) (sent-to-human ?i) (sent-to-robot ?i))
	:effect (and 
		(set ?oi1)
	)
)
...
(:action goto-rrc1
	...
	:precondition (and (set ?w2) (set ?oi) (sent-to-robot ?iq) (sent-to-human ?i) (set ?w1) (not (sent-to-human ?iq)) (not (sent-to-robot ?i)))
	:effect (and 
		(not (sent-to-human ?i))
	)
)
...
(:action goto-rrc2
	...
	:precondition (and (sent-to-human ?iq) (set ?w))
	:effect (and 
		(set ?oi2)
		(set ?oi1)
	)
...
(:action goto-cr
	...
	:precondition (and (set ?oi1) (sent-to-human ?b) (set ?oi2) (sent-to-robot ?b))
	:effect (and 
		(not (sent-to-human ?b))
	)
)
...
(:action goto-rwc2
	...
	:precondition (and (set ?w1) (set ?w2) (sent-to-robot ?sq))
	:effect (and 
		(sent-to-human ?sq)
...
(:action goto-cir
	:parameters (?oi1 - oi1 ?oi2 - oi2 ?b - b)
	:precondition (and (set ?oi1) (sent-to-robot ?b))
	:effect (and 
		(sent-to-human ?b)
		(not (set ?oi1))
	)
