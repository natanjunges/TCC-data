...
(:action goto-rrc1
	...
	:precondition (and (set ?w2) (set ?oi) (sent-to-robot ?i) (set ?w1) (sent-to-robot ?iq))
	:effect (and 
		(not (sent-to-robot ?i))
		(sent-to-human ?i)
	)
...
(:action goto-rrc2
	...
	:precondition (and (set ?w) (set ?oi1))
	:effect (and 
		(sent-to-robot ?iq)
		(sent-to-human ?iq)
		(not (set ?oi1))
...
(:action goto-rwc1
	...
	:precondition (and (sent-to-human ?s) (sent-to-human ?sq) (sent-to-robot ?s))
	:effect (and 
		(not (sent-to-human ?s))
