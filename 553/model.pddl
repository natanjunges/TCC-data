...
(:action goto-rrc1
	...
	:precondition (and (set ?oi) (set ?w2) (sent-to-human ?i) (not (sent-to-human ?iq)) (not (sent-to-robot ?i)))
	:effect (and 
		(set ?w1)
		(sent-to-robot ?iq)
		(not (sent-to-human ?i))
...
(:action goto-cr
	...
	:precondition (and (sent-to-human ?b) (set ?oi2) (sent-to-robot ?b))
	:effect (and 
		(not (set ?oi2))
	)
)
...
(:action goto-cw1
	...
	:precondition (and (set ?w2) (set ?w1) (sent-to-human ?b) (sent-to-robot ?b))
	:effect (and 
		(not (sent-to-human ?b))
		(not (set ?w1))
	)
