...
(:action goto-cr
	...
	:precondition (and (sent-to-human ?b) (set ?oi2))
	:effect (and 
		(not (sent-to-human ?b))
		(sent-to-robot ?b)
	)
...
(:action goto-tw
	...
	:precondition (and (set ?w1) (sent-to-human ?s))
	:effect (and 
		(not (set ?w1))
		(sent-to-robot ?s)
	)
...
(:action goto-rwc2
	...
	:precondition (and (set ?w1) (sent-to-robot ?sq) (set ?w2))
	:effect (and 
		(sent-to-human ?sq)
	)
)
...
(:action goto-cw1
	...
	:precondition (and (set ?w1) (sent-to-human ?b) (sent-to-robot ?b) (set ?w2))
	:effect (and 
		(not (set ?w1))
		(not (sent-to-human ?b))
	)
