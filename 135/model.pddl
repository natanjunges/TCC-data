...
(:action goto-rrc1
	...
	:precondition (and (set ?w2) (sent-to-human ?i) (set ?oi) (set ?w1) (not (sent-to-human ?iq)) (not (sent-to-robot ?i)))
	:effect (and 
		(sent-to-robot ?iq)
		(not (sent-to-human ?i))
	)
...
(:action goto-rrc2
	...
	:precondition (and (set ?oi1) (sent-to-human ?iq) (set ?oi2) (sent-to-robot ?iq))
	:effect (and 
...
(:action goto-tw
	...
	:precondition (and (sent-to-human ?s) (sent-to-robot ?s) (set ?w1))
	:effect (and 
		(not (sent-to-robot ?s))
		(not (set ?w1))
	)
