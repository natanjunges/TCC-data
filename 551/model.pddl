...
(:action goto-rrc2
	...
	:precondition (and (sent-to-robot ?iq) (set ?oi1) (not (sent-to-human ?iq)) (not (set ?w)))
	:effect (and 
		(set ?oi2)
...
(:action goto-tw
	...
	:precondition (and (not (sent-to-human ?s)) (not (set ?w1)) (not (set ?w2)))
	:effect (and 
		(sent-to-robot ?s)
	)
)
...
(:action goto-rwc1
	...
	:precondition (and (sent-to-human ?s) (sent-to-robot ?sq))
	:effect (and 
		(sent-to-human ?sq)
		(not (sent-to-human ?s))
		(sent-to-robot ?s)
...
(:action goto-cw1
	...
	:precondition (and (sent-to-human ?b) (set ?w1) (sent-to-robot ?b))
	:effect (and 
		(not (sent-to-human ?b))
		(not (set ?w1))
		(set ?w2)
