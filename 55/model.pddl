...
(:action goto-rrc1
	...
	:precondition (and (set ?oi) (set ?w1) (set ?w2) (sent-to-human ?i) (not (sent-to-human ?iq)) (not (sent-to-robot ?i)) (sent-to-robot ?iq))
	:effect (and 
		(not (set ?w1))
		(not (sent-to-human ?i))
	)
...
(:action goto-rwc1
	...
	:precondition (and (sent-to-robot ?sq) (sent-to-human ?s) (sent-to-robot ?s) (sent-to-human ?sq))
	:effect (and 
		(not (sent-to-robot ?s))
...
(:action goto-ric2
	...
	:precondition (and (set ?w1) (set ?oi))
	:effect (and 
		(not (set ?w1))
	)
)
