...
(:action goto-rwc2
	...
	:precondition (and (set ?w2) (sent-to-robot ?sq) (sent-to-human ?sq) (set ?w1))
	:effect (and 
	)
)
...
(:action goto-rirc1
	:parameters (?oi - oi ?w1 - w1 ?w2 - w2 ?i - i ?iq - iq)
	:precondition (and (sent-to-robot ?iq) (sent-to-human ?iq) (sent-to-human ?i))
	:effect (and 
		(sent-to-robot ?i)
	)
)
...
(:action goto-cir
	:parameters (?oi1 - oi1 ?oi2 - oi2 ?b - b)
	:precondition (and (set ?oi2) (sent-to-robot ?b) (sent-to-human ?b))
	:effect (and 
		(not (sent-to-robot ?b))
		(not (sent-to-human ?b))
		(set ?oi1)
